...
- Phase 2: Hint penalties removed from Y1 **code**, DA L2 prediction disabled, DA L3 scoring simplified. **This line used to claim "all", and used to claim Y1 was clean in "code + UI text" — both measured false.** Finished 2026-08-26 for three of the four stragglers: `1-ar/dimensional-analysis` (two phantom strings), `3-ar/gas-law-challenge` (a phantom string, never rendered), and `2-ar/hess-law`, whose Level 3 penalty was **real** — 20 points unaided against 10 with a hint — and is now a flat 20 either way. **`3-ar/ph-titration` is the one left**, and it too applies a real multiplier (`Level1.tsx:47,87`, `Level2.tsx:454-455`, `Level3.tsx:309-310`), so removing it is a scoring decision, not a bug fix
