...
export const periodicPuzzles: PeriodicConfigPuzzle[] = [
  ...
  },
  {
    ...
    exceptionExplanation_is:
      'Króm er undantekning! Hálffyllt d-undirhvolf (3d⁵) er sérlega stöðugt, svo ein rafeind flytur úr 4s yfir í 3d. Vænt: [Ar] 4s² 3d⁴, raunverulegt: [Ar] 4s¹ 3d⁵.',
  ...
  },
  {
    ...
    isException: true,
    exceptionExplanation_is:
      'Kopar er undantekning! Fullfyllt d-undirhvolf (3d¹⁰) er sérlega stöðugt, svo ein rafeind flytur úr 4s yfir í 3d. Vænt: [Ar] 4s² 3d⁹, raunverulegt: [Ar] 4s¹ 3d¹⁰.',
    exceptionExplanation_en:
