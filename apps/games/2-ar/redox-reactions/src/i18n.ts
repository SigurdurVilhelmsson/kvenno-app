...
export const gameTranslations = createGameTranslations({
  is: {
    ...
    menu: {
      ...
      subtitle: 'Lærðu um rafeindaflutning og redox-hvörf',
      ...
      level3Desc: 'Notaðu hálfhvarfsaðferðina',
    ...
    complete: {
      ...
      level3Desc: 'Hálfhvarfsaðferðin',
      totalScore: 'Heildarstig',
      whatLearned: 'Hvað lærðir þú?',
      learnOxNum: 'Ímynduð hleðsla ef öll tengi væru jónatengi',
      learnOx: 'Tapa rafeindum = oxunartala hækkar',
      learnRed: 'Öðlast rafeindir = oxunartala lækkar',
      learnBalance: 'Rafeindir sem ein tegund tapar = rafeindir sem önnur öðlast',
    ...
    concepts: {
      ...
      electronTransfer: 'Rafeindaflutningur',
      balancing: 'Stilling',
    },
    rules: {
  ...
  en: {
    ...
    complete: {
      ...
      learnOxNum: 'Imaginary charge if all bonds were ionic',
      learnOx: 'Lose electrons = oxidation number increases',
      learnRed: 'Gain electrons = oxidation number decreases',
      learnBalance: 'Electrons lost = electrons gained',
  ...
  pl: {
    ...
    complete: {
      ...
      learnOxNum: 'Wyobrażony ładunek gdyby wszystkie wiązania były jonowe',
      learnOx: 'Utrata elektronów = stopień utlenienia rośnie',
      learnRed: 'Zyskanie elektronów = stopień utlenienia maleje',
      learnBalance: 'Utracone elektrony = zyskane elektrony',
