...
export const challenges: MechanismChallenge[] = [
  {
    id: 1,
    title: 'Milliefni',
    description: 'Milliefni myndast í einu skrefi og eyðist í öðru.',
    ...
    question: 'Hvert er milliefnið í þessum hvarfgangi?',
    ...
    options: [
      {
        ...
        text: 'F (flúoratóm)',
        correct: true,
        explanation: 'F myndast í skrefi 1 og eyðist í skrefi 2 - klassískt milliefni!',
      },
      {
        id: 'b',
        text: 'NO₂',
      ...
      { id: 'c', text: 'NO₂F', correct: false, explanation: 'NO₂F er lokaafurð, ekki milliefni.' },
      {
        id: 'd',
        text: 'F₂',
        correct: false,
    ...
    hint: 'Milliefni birtist á hægri hlið eins skrefs og vinstri hlið annars',
    conceptExplanation:
      'Milliefni eru efni sem myndast og eyðast innan hvarfgangsins. Þau eru aldrei meðal upphaflegra hvarfefna eða lokaafurða.',
  },
  {
    id: 2,
    ...
    options: [
      ...
      },
      {
        ...
        correct: false,
        explanation: 'Hröð skref bíða eftir hægari skrefum.',
      },
      {
        id: 'c',
  ...
  },
  {
    ...
    question: 'Hvert er hraðalögmálið fyrir þetta hvarf?',
    type: 'rate_law',
    options: [
      {
        id: 'a',
        ...
        correct: true,
        explanation:
          "Skref 2 er hægt, en NOBr₂ er milliefni. Setjum jafnvægi frá skrefi 1 inn → [NOBr₂] = K[NO][Br₂], svo hraði = k'[NO][Br₂][NO] = k[NO]²[Br₂].",
      },
      {
        id: 'b',
        text: 'hraði = k[NO][Br₂]',
      ...
      {
        id: 'c',
        text: 'hraði = k[NOBr₂][NO]',
        correct: false,
        explanation: 'Rétt frá skrefi 2, en NOBr₂ er milliefni - ekki má vera í hraðalögmáli.',
      },
      {
        id: 'd',
        text: 'hraði = k[Br₂]',
  ...
  {
    id: 4,
    title: 'Hvatar í hvarfgangi',
    description: 'Hvatar lækka virkjunarorku en breytast ekki sjálfir.',
    overallReaction: '2H₂O₂ → 2H₂O + O₂ (hvataður af I⁻)',
    mechanism: [
    ...
    options: [
      ...
      },
      {
        ...
        text: 'IO⁻',
        correct: false,
        explanation: 'IO⁻ er milliefni (myndast og eyðist), ekki hvati.',
      },
      { id: 'c', text: 'H₂O₂', correct: false, explanation: 'H₂O₂ er hvarfefni sem eyðist.' },
      { id: 'd', text: 'O₂', correct: false, explanation: 'O₂ er myndefni hvarfsins.' },
    ],
    hint: 'Hvati birtist bæði sem hvarfefni og myndefni í heildarferlinu',
    conceptExplanation:
      'Hvati tekur þátt í hvörfum en myndast aftur. Í hvarfgangi sést þetta þar sem hvatinn eyðist í einu skrefi og myndast í öðru.',
  },
  {
    id: 5,
    title: 'Samræmi við tilraun',
    description: 'Hvarfgangur verður að passa við mælt hraðalögmál.',
    overallReaction: 'Cl₂ + CHCl₃ → CCl₄ + HCl',
    mechanism: [
      { equation: 'Cl₂ ⇌ 2Cl', type: 'equilibrium', label: 'Skref 1 (hratt jafnvægi)' },
      { equation: 'Cl + CHCl₃ → CCl₃ + HCl', type: 'slow', label: 'Skref 2 (hægt)' },
      { equation: 'CCl₃ + Cl → CCl₄', type: 'fast', label: 'Skref 3 (hratt)' },
    ],
    question: 'Ef þessi hvarfgangur er réttur, hvert ætti hraðalögmálið að vera?',
    type: 'rate_law',
    options: [
      {
        id: 'a',
        text: 'hraði = k[CHCl₃][Cl₂]^½',
        correct: true,
        explanation:
          "Skref 2 er hægt: hraði = k'[Cl][CHCl₃]. Frá jafnvægi skrefs 1: [Cl] = √(K[Cl₂]). Þannig: hraði = k[CHCl₃][Cl₂]^½.",
      },
      {
        id: 'b',
        text: 'hraði = k[Cl₂][CHCl₃]',
        correct: false,
      ...
      },
      {
        ...
        text: 'hraði = k[Cl][CHCl₃]',
        correct: false,
        explanation: 'Cl er milliefni - ekki má vera í lokahraðalögmáli.',
      },
      {
        id: 'd',
        text: 'hraði = k[Cl₂]',
  ...
  {
    id: 6,
    title: 'Greina hvarfgang',
    description: 'Samræmdu hvarfgang og hraðalögmál.',
    overallReaction: '2N₂O₅ → 4NO₂ + O₂',
    mechanism: [
      { equation: 'N₂O₅ ⇌ NO₂ + NO₃', type: 'equilibrium', label: 'Skref 1 (hratt jafnvægi)' },
      { equation: 'NO₂ + NO₃ → NO₂ + O₂ + NO', type: 'slow', label: 'Skref 2 (hægt)' },
      { equation: 'NO + NO₃ → 2NO₂', type: 'fast', label: 'Skref 3 (hratt)' },
    ],
    question: 'Hvaða milliefni eru í þessum hvarfgangi?',
    type: 'identify_intermediate',
    options: [
      {
        id: 'a',
      ...
      },
      {
        ...
        text: 'Aðeins NO₃',
        correct: false,
        explanation: 'NO myndast líka tímabundið innan hvarfgangsins.',
      },
      {
        id: 'c',
        text: 'Aðeins NO₂',
        correct: false,
        explanation: 'NO₂ er lokaafurð, ekki milliefni.',
      },
      { id: 'd', text: 'Aðeins NO', correct: false, explanation: 'NO₃ er einnig milliefni.' },
    ],
    hint: 'Leitaðu að efnum sem myndast og eyðast innan hvarfgangsins',
    conceptExplanation:
      'Í flóknum hvarfgöngum geta verið mörg milliefni. Þau eru öll efni sem myndast og eyðast innan ferlisins.',
  },
];
