...
export const challenges: KineticsChallenge[] = [
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: 'b',
        text: 'Hraðinn helst sá sami',
        correct: false,
        explanation: 'Þetta myndi gilda fyrir 0. stigs hvörf.',
      },
      {
        id: 'c',
        text: 'Hraðinn fjórfaldast',
        correct: false,
        explanation: 'Þetta myndi gilda fyrir 2. stigs hvörf.',
      },
      {
        id: 'd',
        text: 'Hraðinn helmingast',
        correct: false,
        explanation: 'Hærri styrkur leiðir til hraðari hvörfunar.',
      },
    ],
    hints: {
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: 'c',
        text: 'Hraðafastinn k minnkar',
        correct: false,
        explanation: 'k hækkar með hitastigi samkvæmt Arrhenius jöfnunni.',
      },
      {
        id: 'd',
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: 'b',
        text: 'Hvati eykur hitastig hvarfsins',
        correct: false,
        explanation: 'Hvatar breyta ekki hitastigi.',
      },
      {
        id: 'c',
        text: 'Hvati eykur styrk hvarfefna',
        correct: false,
        explanation: 'Hvatar breyta ekki styrk.',
      },
      {
        id: 'd',
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: 'b',
        text: 'Járnduft er heitara',
        correct: false,
        explanation: 'Hitastig er það sama.',
      },
      {
        id: 'c',
      ...
      {
        id: 'd',
        text: 'Duftið hefur meiri massa',
        correct: false,
        explanation: 'Massi getur verið sá sami.',
      },
    ],
    hints: {
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: 'c',
        text: 'Aðeins rétt stefna',
        correct: false,
        explanation: 'Orkukrafan er nauðsynleg til að rjúfa tengsl.',
      },
      {
        id: 'd',
        text: 'Hvatar verða alltaf að vera til staðar',
        correct: false,
        explanation: 'Hvatar hraða, en hvörf geta gerst án þeirra.',
      },
    ],
    hints: {
