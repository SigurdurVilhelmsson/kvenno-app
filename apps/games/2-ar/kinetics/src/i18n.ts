...
export const gameTranslations = createGameTranslations({
  ...
  pl: {
    game: {
      ...
      description: 'Poznaj szybkość reakcji i co wpływa na szybkość reakcji chemicznych',
    },
    intro: {
    ...
    levels: {
      level1: {
        ...
        description: 'Co wpływa na szybkość reakcji?',
        details: 'Poznaj stężenie, temperaturę i katalizatory.',
      },
      level2: {
    ...
    concepts: {
      reactionRate: 'Szybkość reakcji',
      concentration: 'Stężenie',
      temperature: 'Temperatura',
      catalyst: 'Katalizator',
      activationEnergy: 'Energia aktywacji',
      rateConstant: 'Stała szybkości',
      rateLaw: 'Prawo szybkości',
      reactionOrder: 'Rząd reakcji',
      collisionTheory: 'Teoria zderzeń',
      maxwellBoltzmann: 'Rozkład Maxwella-Boltzmanna',
    },
    simulation: {
      title: 'Symulacja',
      particleSpeed: 'Prędkość cząstek',
      collisionRate: 'Częstotliwość zderzeń',
