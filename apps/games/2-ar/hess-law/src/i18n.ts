...
export const gameTranslations = createGameTranslations({
  is: {
    ...
    intro: {
      ...
      description:
        'Vermi (ΔH) er ástandsfall — það skiptir ekki máli hvaða leið efnahvörfin taka, aðeins upphafs- og lokaaðstæður skipta máli. Þetta þýðir að við getum sameinað jöfnur til að finna ΔH fyrir hvörf sem erfitt er að mæla beint.',
    ...
    levels: {
      ...
      level3: {
        ...
        description: 'Myndunarvermi og flókin hvörf',
    ...
    complete: {
      ...
      learned: {
        ...
        hessLaw: 'Lögmál Hess: ΔH er það sama óháð leiðinni',
        reverse: 'Snúa við: Ef þú snýrð við hvörfum, snýrðu einnig formerki ΔH',
        multiply: 'Margfalda: Ef þú margfaldar jöfnu, margfaldar þú einnig ΔH',
        formation: 'Myndunarvermi: ΔH°rxn = Σ ΔH°f(myndefni) - Σ ΔH°f(hvarfefni)',
      },
    },
    progress: {
      title: 'Framvinda',
    ...
    level3: {
      ...
      tableTitle: 'Myndunarvermi (ΔH°f) í kJ/mól',
      calculation: 'Útreikningur',
      products: 'Myndefni:',
      reactants: 'Hvarfefni:',
      totalProducts: 'Samtals myndefni:',
      ...
      c1hint: 'ΔH°rxn = Σ(n × ΔH°f myndefni) - Σ(n × ΔH°f hvarfefni)',
      c1explanation: 'ΔH°rxn = [1(-393,5) + 2(-285,8)] - [1(-74,8) + 2(0)] = -890,3 kJ/mól',
      c2title: 'Myndun ammóníaks',
      c2desc: 'Finndu ΔH°rxn fyrir Haber-ferlið.',
      c2hint: 'Frumefni í stöðluðu ástandi hafa ΔH°f = 0',
      c2explanation: 'ΔH°rxn = [2(-46,1)] - [1(0) + 3(0)] = -92,2 kJ/mól',
      c3title: 'Niðurbrot kalsíumkarbónats',
      c3desc: 'Reiknaðu ΔH° fyrir niðurbrot kalsíumkarbónats.',
      c3hint: 'Jákvætt ΔH þýðir innvermið hvarf (tekur til sín varma)',
      c3explanation: 'ΔH°rxn = [(-635,1) + (-393,5)] - [(-1206,9)] = +178,3 kJ/mól (innvermið)',
      c4title: 'Óþekkt myndunarvermi',
      c4desc: 'Gefið er ΔH°rxn = -296,8 kJ/mól. Finndu ΔH°f fyrir SO₂(g).',
      c4hint: 'Þetta er myndunarhvarf! ΔH°rxn = ΔH°f fyrir myndefnið.',
      c4explanation:
        'Þar sem hvarfefnin eru frumefni í stöðluðu ástandi: ΔH°rxn = ΔH°f(SO₂) = -296,8 kJ/mól',
      c5title: 'Brennsla etanóls',
      c5desc: 'Reiknaðu varmamyndun við brennslu etanóls.',
      c5hint: 'Mundu að margfalda ΔH°f með stuðlinum!',
      c5explanation: 'ΔH°rxn = [2(-393,5) + 3(-285,8)] - [1(-277,7) + 3(0)] = -1366,7 kJ/mól',
      c6title: 'Termít-efnahvarfið',
      c6desc: 'Reiknaðu orkuna í termít-efnahvarfinu.',
      c6hint: 'Þetta hvarf er mjög útvermið - notað til að sjóða saman járnbrautarteina.',
      c6explanation: 'ΔH°rxn = [1(-1675,7) + 2(0)] - [2(0) + 1(-824,2)] = -851,5 kJ/mól',
    },
  },
  en: {
    game: {
    ...
    complete: {
      ...
      learned: {
        ...
        hessLaw: "Hess's Law: ΔH is the same regardless of the reaction pathway",
