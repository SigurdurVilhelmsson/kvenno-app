...
export const CHALLENGES: Challenge[] = [
  ...
  },
  {
    ...
    question:
      'Myndun vatns: H₂(g) + ½O₂(g) → H₂O(l) hefur ΔH = -286 kJ. Hvað er ΔH fyrir sundrun vatns?',
    options: [
      {
        text: '+286 kJ',
        correct: true,
        explanation: 'Rétt! Þegar þú snýrð við hvörfum, snýrðu einnig formerkinu. -286 → +286',
      },
      {
        text: '-286 kJ',
        correct: false,
        explanation: 'Rangt. Þú þarft að snúa formerkinu þegar þú snýrð við hvörfum.',
      },
      {
        text: '-572 kJ',
        correct: false,
        explanation: 'Rangt. Þú ert að margfalda, ekki snúa við.',
      },
      {
        text: '+572 kJ',
        correct: false,
        explanation: 'Rangt. Þú ert bæði að margfalda og snúa við, en við erum bara að snúa.',
      },
    ],
    hints: {
  ...
  },
  {
    ...
    question:
      'Brennsla kolefnis: C(s) + O₂(g) → CO₂(g) hefur ΔH = -394 kJ. Hvað er ΔH ef við brennum 3 mól af kolefni?',
    options: [
      {
        text: '-1182 kJ',
        correct: true,
      ...
      },
      {
        text: '-394 kJ',
        correct: false,
        explanation: 'Rangt. Þetta er ΔH fyrir 1 mól. Þú þarft að margfalda með 3.',
      },
      { text: '-131 kJ', correct: false, explanation: 'Rangt. Þú ert að deila, ekki margfalda.' },
      {
        text: '+1182 kJ',
        correct: false,
        explanation: 'Rangt. Formerkið breytist ekki við margföldun.',
      },
    ],
    hints: {
    ...
    options: [
      {
        text: '+184 kJ',
        correct: true,
        explanation: 'Rétt! Snúa við: +92 kJ. Margfalda með 2 (4 mól NH₃ = 2× jafnan): +184 kJ',
      },
      {
        text: '-184 kJ',
        correct: false,
      ...
      },
      {
        text: '-92 kJ',
        correct: false,
        explanation: 'Rangt. Þetta er ΔH fyrir myndun, ekki sundrun.',
      },
    ],
    hints: {
    ...
    options: [
      {
        text: '-111 kJ',
        correct: true,
        explanation: 'Rétt! Nota jöfnu (1) og snúa við jöfnu (2): -394 + 283 = -111 kJ',
      },
      {
        text: '-677 kJ',
        correct: false,
      ...
      },
      {
        text: '-394 kJ',
        correct: false,
        explanation: 'Rangt. Þetta er aðeins ΔH fyrir jöfnu (1), en þú þarft að sameina báðar.',
      },
    ],
    hints: {
  ...
  },
  {
    ...
    title: 'Orkubraut',
    description:
      'Hugsaðu um ΔH sem hæðarmismun. Leiðin skiptir ekki máli, aðeins upphafs- og lokastaða.',
    ...
    options: [
      {
        text: '-50 kJ',
        correct: true,
        explanation: 'Rétt! -30 + 10 + (-30) = -50 kJ. Leggðu saman öll ΔH.',
      },
      {
        text: '-70 kJ',
        correct: false,
        explanation: 'Rangt. Gættu að formerkjum: B → C er +10, ekki -10.',
      },
      {
        text: '-30 kJ',
        correct: false,
        explanation: 'Rangt. Þú þarft að leggja saman öll þrjú ΔH.',
      },
