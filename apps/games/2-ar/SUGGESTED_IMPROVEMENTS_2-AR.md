...
> **Superseded — historical.** Written before the April 2026 restructure, so it analyses features that no longer exist and covers only 7 of the 8 Year-2 games (no `rafeindabygging`, created 2026-04-14). Current reviews: `apps/games/1-ar/CURRICULUM_REVIEW.md`, `apps/games/ORPHANED_GAMES_ASSESSMENT.md`. See `docs/README.md`.
...
_Last updated: Based on code analysis of 7 of the 8 Year-2 games — `rafeindabygging` is not covered_
