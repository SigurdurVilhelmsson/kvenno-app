...
/**
 * How Ksp is written for a student: `1,8 × 10⁻¹⁰`, Icelandic decimal comma.
 *
 ...
 *
 * **Two fields, not one, and that is the whole design.** Every answer in this
 * game lives between 10⁻⁵ and 10⁻¹⁷, where a single decimal box is unusable:
