        ...
        <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-2xl p-6 md:p-8">
          ...
          <div className="p-6 rounded-xl mb-8 bg-kvenno-orange/10">
            ...
            <p className="text-warm-800 text-sm mb-4">
              <strong>Stuðpúði</strong> er lausn sem getur viðhaldið stöðugu pH þegar litlu magni af
              sýru eða basa er bætt við. Hann samanstendur af veikri sýru og samoka basa hennar (eða
              veikum basa og samoka sýru hans).
            </p>
            <div className="bg-white p-3 rounded-lg border border-kvenno-orange">
              ...
              <p className="text-xs text-warm-600 text-center mt-1">Henderson-Hasselbalch jafnan</p>
            </div>
          </div>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-xs text-warm-600 mt-2">
                    Notaðu tilbúnar birgðalausnir til að búa til stuðpúða. Reiknaðu rúmmál til að
                    taka úr hverri birgðalausn.
                  </div>
                </div>
              </div>
            </button>
