...
> **Superseded — historical.** Its "all 5 games" scope is complete for Year 3, but it was written before the April 2026 restructure and analyses features that no longer exist. Current reviews: `apps/games/1-ar/CURRICULUM_REVIEW.md`, `apps/games/ORPHANED_GAMES_ASSESSMENT.md`. See `docs/README.md`.
...
_Last updated: Based on code analysis of all 5 games_
