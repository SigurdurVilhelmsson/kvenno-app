...
export const LEVEL1_CHALLENGES: Level1Challenge[] = [
  {
    ...
    type: 'match-curve',
    questionIs:
      'Hvaða títrunarkúrfa sýnir títrun á STERKRI SÝRU með sterkri basa (t.d. HCl + NaOH)?',
    ...
    explanationIs:
      'Sterk sýra + sterk basi hefur jafngildispunkt við pH = 7 vegna þess að saltið sem myndast (t.d. NaCl) er hlutlaust. Upphafs-pH er lágt (~1) vegna þess að sýran er alveg sundurgreind.',
    explanation:
  ...
  },
  {
    ...
    type: 'match-curve',
    questionIs:
      'Hvaða einkenni á títrunarkúrfa fyrir VEIKA SÝRU + sterka basa (t.d. CH₃COOH + NaOH)?',
    question:
    ...
    hints: {
      ...
      strategy:
        'Veik sýra er ekki alveg sundurgreind, svo upphaf-pH er hærra. Hugsaðu hvað myndast við jafngildispunkt.',
      method:
  ...
  },
  {
    ...
    type: 'predict-color',
    questionIs:
      'Fenólftaleín breytir lit frá litlausu í bleiku við pH 8.3-10.0. Hvaða lit sýnir fenólftaleín við jafngildispunkt títrunar HCl + NaOH (pH = 7)?',
    question:
    ...
    explanationIs:
      'Við pH 7 (jafngildispunktur HCl + NaOH) er fenólftaleín LITLAUS vegna þess að pH < 8.3. Þetta þýðir að fenólftaleín er EKKI góður vísir fyrir sterka sýru + sterka basa títrun!',
    explanation:
  ...
  },
  {
    ...
    type: 'predict-color',
    questionIs:
      'Metýl appelsínugult (methyl orange) breytir lit frá rauðu í appelsínugult við pH 3.1-4.4. Hvaða lit sýnir það við pH 2?',
    question:
    ...
    hints: {
      ...
      method:
        'Metýl appelsínugult er rautt undir pH 3.1, appelsínugult á milli, og gult yfir pH 4.4.',
      solution: 'pH 2 < 3.1, svo metýl appelsínugult er RAUTT.',
    },
    explanationIs:
      'Við pH 2 er lausnin mjög súr (undir 3.1), svo metýl appelsínugult sýnir RAUÐAN lit. Í sýru er vísirinn í prótónformi sínu.',
    explanation:
  ...
  },
  {
    ...
    explanationIs:
      'Besti vísirinn hefur litbreytingasvið sem inniheldur jafngildispunkt títrunarinnar. T.d.: HCl + NaOH (pH 7) → metýl rautt eða brómþýmól blátt; CH₃COOH + NaOH (pH ~9) → fenólftaleín.',
    explanation:
