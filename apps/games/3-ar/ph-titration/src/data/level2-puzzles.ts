...
export const LEVEL2_PUZZLES: Level2Puzzle[] = [
  {
    ...
    hintIs:
      'Fyrir sterka sýru + sterka basa er jafngildispunktur við pH = 7. Veldu vísi sem breytir lit nálægt pH 7.',
    hint: 'For strong acid + strong base, equivalence point is at pH = 7. Choose an indicator that changes color near pH 7.',
    explanationIs:
      'HCl + NaOH gefur NaCl + H₂O. Saltið NaCl er hlutlaust, svo jafngildispunktur er við pH = 7. Metýl rautt (pH 4.4-6.2) eða brómþýmól blátt (pH 6.0-7.6) eru góðir vísar.',
    explanation:
  ...
  },
  {
    ...
    hintIs:
      'Veik sýra + sterk basi myndar basíska samþjöppuðu basa við jafngildispunkt. pH verður hærra en 7.',
    hint: 'Weak acid + strong base forms basic conjugate base at equivalence. pH will be higher than 7.',
    explanationIs:
      'CH₃COOH + NaOH gefur CH₃COONa. Asetat jónin (CH₃COO⁻) er veik basi, svo lausnin verður basísk við jafngildispunkt (~pH 8.7). Fenólftaleín (pH 8.3-10.0) er besti vísirinn.',
    explanation:
  ...
  },
  {
    ...
    hintIs:
      'Veik basi + sterk sýra myndar súra samþjöppuðu sýru við jafngildispunkt. pH verður lægra en 7.',
    hint: 'Weak base + strong acid forms acidic conjugate acid at equivalence. pH will be lower than 7.',
    explanationIs:
      'NH₃ + HCl gefur NH₄Cl. Ammóníum jónin (NH₄⁺) er veik sýra, svo lausnin verður súr við jafngildispunkt (~pH 5.3). Metýl appelsínugult (pH 3.1-4.4) er góður vísir.',
    explanation:
  ...
  },
  {
    ...
    explanationIs:
      'HF + NaOH gefur NaF. Flúoríð jónin (F⁻) er veik basi (samþjöppuð basi HF), svo lausnin verður basísk við jafngildispunkt. pKₐ(HF) ≈ 3.17.',
    explanation:
