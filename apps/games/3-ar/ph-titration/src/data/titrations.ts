...
export const titrations: Titration[] = [
  // ===== BEGINNER LEVEL (Strong Acid + Strong Base) =====
  {
    ...
    type: 'strong-strong',
    name: 'HCl + NaOH',
    analyte: { formula: 'HCl', volume: 25.0, molarity: 0.1, name: 'Saltssýra' },
  ...
  },
  {
    ...
    type: 'strong-strong',
    name: 'HNO₃ + KOH',
    analyte: { formula: 'HNO₃', volume: 30.0, molarity: 0.05, name: 'Saltpéturssýra' },
    titrant: { formula: 'KOH', molarity: 0.1, name: 'Kalíumhýdroxíð' },
  ...
  },
  {
    ...
    type: 'strong-strong',
    name: 'HCl + NaOH',
    analyte: { formula: 'HCl', volume: 50.0, molarity: 0.2, name: 'Saltssýra' },
    titrant: { formula: 'NaOH', molarity: 0.1, name: 'Natríumhýdroxíð' },
  ...
  },
  {
    ...
    titrant: { formula: 'LiOH', molarity: 0.1, name: 'Litíumhýdroxíð' },
  ...
  // ===== INTERMEDIATE LEVEL (Weak Acid + Strong Base) =====
  {
    ...
    type: 'weak-strong',
    name: 'CH₃COOH + NaOH',
    analyte: { formula: 'CH₃COOH', volume: 25.0, molarity: 0.1, name: 'Ediksýra' },
    titrant: { formula: 'NaOH', molarity: 0.1, name: 'Natríumhýdroxíð' },
    equivalenceVolume: 25.0,
    equivalencePH: 8.72,
    initialPH: 2.87,
  ...
  },
  {
    ...
    type: 'weak-strong',
    name: 'HF + NaOH',
    analyte: { formula: 'HF', volume: 30.0, molarity: 0.15, name: 'Flússýra' },
    titrant: { formula: 'NaOH', molarity: 0.1, name: 'Natríumhýdroxíð' },
  ...
  },
  {
    ...
    type: 'weak-strong',
    name: 'HCOOH + KOH',
    analyte: { formula: 'HCOOH', volume: 20.0, molarity: 0.2, name: 'Maurasýra' },
    titrant: { formula: 'KOH', molarity: 0.1, name: 'Kalíumhýdroxíð' },
  ...
  // ===== INTERMEDIATE LEVEL (Weak Base + Strong Acid) =====
  {
    ...
    type: 'strong-weak',
    name: 'NH₃ + HCl',
    analyte: { formula: 'NH₃', volume: 25.0, molarity: 0.1, name: 'Ammoníak' },
    titrant: { formula: 'HCl', molarity: 0.1, name: 'Saltssýra' },
    equivalenceVolume: 25.0,
    equivalencePH: 5.28,
    initialPH: 11.13,
  ...
  },
  {
    ...
    type: 'strong-weak',
    name: 'CH₃NH₂ + HCl',
    analyte: { formula: 'CH₃NH₂', volume: 25.0, molarity: 0.1, name: 'Metýlamín' },
    titrant: { formula: 'HCl', molarity: 0.1, name: 'Saltssýra' },
    equivalenceVolume: 25.0,
    equivalencePH: 5.82,
    initialPH: 11.82,
  ...
  },
  {
    ...
    type: 'polyprotic-diprotic',
    name: 'H₂C₂O₄ + NaOH',
    analyte: { formula: 'H₂C₂O₄', volume: 30.0, molarity: 0.08, name: 'Oxalsýra' },
    titrant: { formula: 'NaOH', molarity: 0.1, name: 'Natríumhýdroxíð' },
  ...
  },
  {
    ...
    name: 'H₃PO₄ + NaOH',
    analyte: { formula: 'H₃PO₄', volume: 25.0, molarity: 0.1, name: 'Fosfórsýra' },
    titrant: { formula: 'NaOH', molarity: 0.1, name: 'Natríumhýdroxíð' },
    equivalenceVolumes: [25.0, 50.0, 75.0],
    equivalencePHs: [4.7, 9.8, 12.4],
    initialPH: 1.6,
    halfEquivalencePHs: [2.15, 7.2, 12.35],
    bestIndicator: 'phenolphthalein',
