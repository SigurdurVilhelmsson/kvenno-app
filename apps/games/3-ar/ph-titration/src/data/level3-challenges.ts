...
export const LEVEL3_CHALLENGES: Level3Challenge[] = [
  // === FIND CONCENTRATION PROBLEMS ===
  {
    ...
    tolerance: 0.02,
    hintIs:
      'Notaðu hlutfallið: n(HCl) = n(NaOH) við jafngildispunkt. Molfjöldi = styrkur × rúmmál.',
  ...
  },
  {
    ...
    tolerance: 0.02,
    hintIs:
      'Sama aðferð og fyrir sterka sýru - einungis molfjöldi skiptir máli við jafngildispunkt.',
    hint: 'Same method as for strong acid - only moles matter at equivalence point.',
    explanationIs:
      'Hvort sem sýran er sterk eða veik, er molfjöldi sýru og basa jafnt við jafngildispunkt.',
    explanation:
  ...
  // === POLYPROTIC PROBLEMS ===
  {
    ...
    hintIs:
      'Tvíprótón sýra gefur 2 mól H⁺ fyrir hvert mól sýru. Við annan jafngildispunkt hafa bæði H⁺ hvarfast.',
