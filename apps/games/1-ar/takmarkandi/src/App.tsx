...
function App() {
  ...
  const handleLevel1Complete = (score: number, maxScore: number, hintsUsed: number) => {
    ...
    setProgress((prev) => {
      ...
      allComplete = !prev.level1Completed && updated.level2Completed && updated.level3BestScore > 0;
      return updated;
    });
  ...
  const handleLevel2Complete = (score: number, maxScore: number, hintsUsed: number) => {
    ...
    setProgress((prev) => {
      ...
      allComplete = updated.level1Completed && !prev.level2Completed && updated.level3BestScore > 0;
      return updated;
    });
  ...
  const handleLevel3Complete = (
    ...
    setProgress((prev) => {
      ...
      allComplete =
        updated.level1Completed && updated.level2Completed && !(prev.level3BestScore > 0);
      return updated;
    });
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-6">
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="flex-1">
                <h1 className="text-4xl font-bold font-heading text-center mb-2 text-warm-800">
                  {t('game.title', 'Takmarkandi Hvarfefni')}
                </h1>
