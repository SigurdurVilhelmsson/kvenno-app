...
export const COMPOUNDS: Compound[] = [
  // EASY (21 compounds)
  {
    ...
    difficulty: 'easy',
    elements: ['Na', 'Cl'],
    info: 'Málmur + Málmleysingi → Jónefni',
  },
  {
    formula: 'H₂O',
    name: 'Vatn',
  ...
  },
  {
    ...
    difficulty: 'easy',
    elements: ['Na', 'O'],
    info: 'Tvö Na⁺ fyrir hvert O²⁻',
  },
  {
    formula: 'MgCl₂',
    name: 'Magnesíumklóríð',
    type: 'ionic',
    category: 'jónefni',
    difficulty: 'easy',
    elements: ['Mg', 'Cl'],
  ...
  {
    formula: 'CuSO₄',
    name: 'Kopar(II)súlfat',
    type: 'ionic',
    category: 'málmar-breytilega-hleðsla',
    difficulty: 'medium',
    elements: ['Cu', 'S', 'O'],
    info: 'Kopar + Súlfat (SO₄²⁻)',
  },
  {
    formula: 'Na₂CO₃',
  ...
  },
  {
    ...
    difficulty: 'medium',
    elements: ['P', 'O'],
    info: 'Fjórir fosfórar, tíu súrefni',
  },
  {
    formula: '(NH₄)₂SO₄',
    name: 'Ammóníumsúlfat',
    ...
    difficulty: 'medium',
    elements: ['N', 'H', 'S', 'O'],
    info: 'Tvö ammóníum + súlfat',
  },

  // HARD (20 compounds)
  {
    formula: 'Fe(NO₃)₃',
    name: 'Járn(III)nítrat',
    type: 'ionic',
    category: 'málmar-breytilega-hleðsla',
    difficulty: 'hard',
    elements: ['Fe', 'N', 'O'],
    info: 'Járn +3, þrjú nítrat',
  },
  {
    formula: 'Cu₂O',
    name: 'Kopar(I)oxíð',
    ...
    difficulty: 'hard',
    elements: ['Cu', 'O'],
    info: 'Kopar með +1 hleðslu',
  },
  {
    formula: 'Mn₂O₇',
    name: 'Mangan(VII)oxíð',
    type: 'ionic',
    category: 'málmar-breytilega-hleðsla',
    difficulty: 'hard',
    elements: ['Mn', 'O'],
    info: 'Hæsta oxunarstig',
  },
  {
    formula: 'Cr₂O₃',
    name: 'Króm(III)oxíð',
  ...
  },
  {
    ...
    difficulty: 'hard',
    elements: ['Pb', 'N', 'O'],
    info: 'Blý +2, tvö nítrat',
  },
  {
    formula: 'HgCl₂',
    name: 'Kvikasilfur(II)klóríð',
    type: 'ionic',
    category: 'málmar-breytilega-hleðsla',
    difficulty: 'hard',
    elements: ['Hg', 'Cl'],
  ...
  },
  {
    ...
    difficulty: 'hard',
    elements: ['Ca', 'P', 'O'],
    info: 'Þrjú kalsíum, tvö fosfat',
  },
  {
    formula: 'N₂O₅',
    name: 'Díniturpentoxíð',
    type: 'molecular',
    category: 'sameind',
    difficulty: 'hard',
    elements: ['N', 'O'],
  ...
  },
  {
    ...
    difficulty: 'hard',
    elements: ['P', 'Cl'],
    info: 'Einn fosfór, fimm klór',
  },
  {
    formula: 'IF₇',
    name: 'Joðheptaflúoríð',
    type: 'molecular',
    category: 'sameind',
    difficulty: 'hard',
    elements: ['I', 'F'],
    info: 'Eitt joð, sjö flúor',
  },
  {
    formula: 'XeF₄',
