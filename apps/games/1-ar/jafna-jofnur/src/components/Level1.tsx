...
/** Pick all easy reactions, shuffled */
function selectProblems(): Reaction[] {
  return shuffle(REACTIONS.filter((r) => r.difficulty === 'easy'));
}

/**
 * Level 1: Einfaldar jöfnur (Simple Equations)
 * - 7 easy reactions (2-element, small coefficients 1-4)
 * - Show hint: highlight which element is unbalanced
 * - AtomCounter always visible
      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-md p-4 mb-4">
          <div className="flex justify-between items-center">
            ...
            <h1 className="text-lg font-bold text-warm-800">Einfaldar jöfnur – Stig 1</h1>
        ...
        <div className="bg-green-50 border border-green-200 rounded-xl p-3 mb-4 text-sm text-green-800">
          Notaðu + og - takkana til að breyta stuðlum og jafna jöfnuna.
        </div>
        ...
        {/* Atom Counter - always visible, highlights unbalanced */}
        <div className="mb-4">
          <AtomCounter elements={balanceResult.elements} highlightUnbalanced={showHint} />
        </div>

        {/* Check button — primary action, always visible */}
        {!answered && (
          <button
            onClick={handleCheck}
        ...
        {/* Hint button — secondary, below check */}
