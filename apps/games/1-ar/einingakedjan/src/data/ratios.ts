...
export const molarMassRatios: Equivalence[] = [
  {
    ...
    right: { value: 1, unit: 'mól', species: 'Mg' },
    kind: 'molmassi',
  },
  {
    id: 'mm-MgO',
  ...
  },
  {
    ...
    right: { value: 1, unit: 'mól', species: 'NaCl' },
    kind: 'molmassi',
  },
  {
    id: 'mm-H2O',
    left: { value: 18.02, unit: 'g', species: 'H₂O' },
    right: { value: 1, unit: 'mól', species: 'H₂O' },
    kind: 'molmassi',
  },
  {
    id: 'mm-etanol',
    left: { value: 46.07, unit: 'g', species: 'C₂H₅OH' },
    right: { value: 1, unit: 'mól', species: 'C₂H₅OH' },
    kind: 'molmassi',
  },
  {
    id: 'mm-NaHCO3',
    left: { value: 84.01, unit: 'g', species: 'NaHCO₃' },
    right: { value: 1, unit: 'mól', species: 'NaHCO₃' },
    kind: 'molmassi',
  },
  {
    id: 'mm-Na2CO3',
    left: { value: 105.99, unit: 'g', species: 'Na₂CO₃' },
    right: { value: 1, unit: 'mól', species: 'Na₂CO₃' },
    kind: 'molmassi',
  },
  {
    id: 'mm-CO2',
    left: { value: 44.01, unit: 'g', species: 'CO₂' },
    right: { value: 1, unit: 'mól', species: 'CO₂' },
    kind: 'molmassi',
  },
  {
    id: 'mm-CaCO3',
    left: { value: 100.09, unit: 'g', species: 'CaCO₃' },
    right: { value: 1, unit: 'mól', species: 'CaCO₃' },
    kind: 'molmassi',
  },
  {
    id: 'mm-Fe',
    left: { value: 55.85, unit: 'g', species: 'Fe' },
    right: { value: 1, unit: 'mól', species: 'Fe' },
    kind: 'molmassi',
  },
  {
    id: 'mm-Fe2O3',
    left: { value: 159.69, unit: 'g', species: 'Fe₂O₃' },
    right: { value: 1, unit: 'mól', species: 'Fe₂O₃' },
    kind: 'molmassi',
  },
  {
    id: 'mm-NaOH',
  ...
  },
  {
    ...
    right: { value: 1, unit: 'mól', species: 'HCl' },
    kind: 'molmassi',
  },
];
...
export const equationRatios: Equivalence[] = [
  {
    id: 'jafna-Mg-MgO',
    left: { value: 2, unit: 'mól', species: 'Mg' },
    right: { value: 2, unit: 'mól', species: 'MgO' },
    kind: 'jafna',
    source: '2 Mg + O₂ → 2 MgO',
  },
  {
  ...
  {
    id: 'jafna-NaHCO3-CO2',
    left: { value: 2, unit: 'mól', species: 'NaHCO₃' },
    right: { value: 1, unit: 'mól', species: 'CO₂' },
    kind: 'jafna',
  ...
  {
    id: 'jafna-CaCO3-HCl',
    left: { value: 1, unit: 'mól', species: 'CaCO₃' },
    right: { value: 2, unit: 'mól', species: 'HCl' },
    kind: 'jafna',
  ...
  {
    id: 'jafna-etanol-CO2',
    left: { value: 1, unit: 'mól', species: 'C₂H₅OH' },
    right: { value: 2, unit: 'mól', species: 'CO₂' },
    kind: 'jafna',
  ...
  },
  {
    id: 'jafna-etanol-O2',
    left: { value: 1, unit: 'mól', species: 'C₂H₅OH' },
    right: { value: 3, unit: 'mól', species: 'O₂' },
    kind: 'jafna',
    source: 'C₂H₅OH + 3 O₂ → 2 CO₂ + 3 H₂O',
  },
  {
    id: 'jafna-Fe-Fe2O3',
    left: { value: 4, unit: 'mól', species: 'Fe' },
    right: { value: 2, unit: 'mól', species: 'Fe₂O₃' },
    kind: 'jafna',
