 ...
 *
 * On a phone a side can be wider than its card (`6,022 × 10²³ formúlueiningar
 ...
 *
 * Which way up it is *is* the skill, and the rule alone says nothing to a
 * screen reader, so the bar is also spoken.
 */
...
interface ChainCardProps {
  ...
  position: number;
  /**
   * Turn the card over and take it back out. Without them the card is shown
   * read-only, as the chain is while the student predicts its outcome.
   */
  onFlip?: () => void;
  onRemove?: () => void;
