...
export const level3Challenges: Level3Challenge[] = [
  ...
  },
  {
    ...
    type: 'synthesis',
    prompt:
      '🔬 Þú ert að undirbúa tilraun sem krefst 0,5 mól af NaCl. Mólmassi NaCl er 58,5 g/mól. Hversu mörg grömm þarftu?',
    startValue: 0.5,
    startUnit: 'mól',
    ...
    significantFigures: 3,
    requiredSteps: ['⚗️ Margfaldaðu efnismagn með mólmassa (g = mól × g/mól)'],
  },
  {
    id: 'L3-13',
    type: 'real_world',
