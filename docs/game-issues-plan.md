...
- [x] **1-06. feedbackGenerator.ts untested** — Added 21 unit tests covering all 4 challenge types (count_atoms, compare_mass, build_molecule, estimate_range), correct/incorrect paths, default case, and DetailedFeedback shape compliance. *(Session I)*
...
### Minor
- [x] **4-05. Limited chemical database** (only 7 chemicals) — Expanded from 9 to 21 chemicals across all 3 difficulty tiers (simple: +4 including KCl, NaHCO₃, súkrósa, etanól; medium: +4 including HNO₃, Na₂CO₃, NH₄Cl, CH₃COOH; hard: +4 including Ca(OH)₂, K₂Cr₂O₇, FeCl₃, H₃PO₄). *(Session I)*
- [x] **4-06. Chemistry facts pool too small** (only 7 facts) — Expanded from 7 to 18 facts covering solution concentrations (blood, seawater, vinegar, stomach acid), safety tips, pH concepts, ionic conductivity, saturation, dilution formulas, endothermic dissolution. All in Icelandic. *(Session I)*
