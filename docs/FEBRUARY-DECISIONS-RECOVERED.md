...
| 6   | Stoichiometry                                        | ❌ **OPEN, and kvenno ships three words.** `stökjómetríu` (`takmarkandi/src/App.tsx:251`, `i18n.ts:51`), `Stökefnafræði` (`hess-law/src/components/Level1.tsx:25`), `stækifræði` (`stilla-efnajofnur/src/i18n.ts:11`). No glossary entry; neither PR touched it.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
