...
- Still-open, unrelated: `2-ar/hess-law/src/i18n.ts:76` and `3-ar/gas-law-challenge/src/i18n.ts:34` advertise a hint cost on the affordance, and `3-ar/ph-titration` applies one as a real multiplier (`Level1.tsx:47,87`, `Level2.tsx:454-455`, `Level3.tsx:309-310`). Those were out of scope here.
