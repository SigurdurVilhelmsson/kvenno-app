...
> **Update 2026-08-26.** Phase 1b closed **B3, B6 and B8** on 2026-08-18 (PR #24), and **B4 and
> B13** were closed on 2026-08-26 (PR #30), so of the seven below **two remain open: B12 and B5**. The three fixed rows are marked in place; their
> descriptions are the pre-fix state and their measured rates were later sharpened — see
> `docs/README.md`. This is the table `CLAUDE.md` points at for the remaining items.
