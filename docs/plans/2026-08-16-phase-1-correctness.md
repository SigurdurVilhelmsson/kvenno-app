...
> **Update 2026-08-26.** Phase 1b closed **B3, B6 and B8** on 2026-08-18 (PR #24), so of the seven
> below **four remain open: B12, B4, B5, B13**. The three fixed rows are marked in place; their
